document.addEventListener('DOMContentLoaded', function() {
    // Version 1.0.2
    // Remove the JavaScript that loads CSS as text - let the link tag handle styling
    ...
    // Add event listener for copy button (this needs to be inside DOMContentLoaded)
